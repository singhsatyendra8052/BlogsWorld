  ...
  return (
    <div className="fixed top-0 left-0 bg-cover bg-center w-full h-full z-10">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/1486121/pexels-photo-1486121.jpeg')",
        }}
      >
        <Navbar />
            ...
            <div className="md:sticky md:top-12  flex justify-start md:justify-end items-start md:w-[30%] w-full md:items-end ">
              <div className=" flex flex-col space-y-4 items-start">
                ...
                <input
                  ...
                  value={username}
                  className="outline-none px-4 py-2 text-black backdrop-blur-sm bg-white/30 rounded-md"
