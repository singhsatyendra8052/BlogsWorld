    ...
    <>
      ...
      >
        ...
        <div className="w-full flex justify-center items-center h-[80vh] relative ">
          <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]  bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
            <h1 className="text-xl font-bold text-left">Create an account</h1>
            <input
              onChange={(e) => setUsername(e.target.value)}
              className="w-[75%] px-4 py-2 border-2 border-grey outline-0 rounded-md"
              type="text"
